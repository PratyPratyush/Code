...
// 		trr.head=null;
// 		while(n-->0){
// 			trr.head=trr.insert(trr.head,sc.nextInt());
// 		}
// 		trr.print_tree(trr.head);
// 	}
// }
//==================================================================
//        Level order Traversal(Top to bottom) && Heigth of the Tree
//==================================================================
// import java.io.*;
// import java.util.*;
// class All{
...
// 		}
// 	}
// 	int height_of(Node ptr){
// 		if(ptr==null) return -1;
// 		int left = height_of(ptr.left);
// 		int right = height_of(ptr.right);
...
// 			trr.head=trr.insert(trr.head,sc.nextInt());
// 		}
// 		int h = trr.height_of(trr.head);
// 		System.out.println("Height of tree is "+h);
// 		System.out.println("Level oder traversel----");
// 		trr.print_tree(trr.head);
// 		System.out.println(" ");
// 	}
// }
